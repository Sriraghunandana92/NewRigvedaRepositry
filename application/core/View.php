...
class View {
    ...
    public function printNavigation($navigation = array(), $ulClass = ' class="navbar-nav mx-auto"', $liClass = ' class="nav-item"') {
        ...
        foreach ($navigation as $mainNav) {
            ...
            if(is_array($mainNav)){
                ...
                if($anchorText) {
                	...
                	echo "\t" . '<li><a class="nav-link" ' . $targetBlank . 'href="' . $navLink . '">' . $anchorText . '</a></li>' . "\n";
                }
                else{
